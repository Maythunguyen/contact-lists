...
const ContactCard = ({ contact }) => {
  return (
    <div className="w-full max-w-sm rounded-xl overflow-hidden bg-white shadow-subtle dark:bg-neutral-800 transition-transform duration-300 ease-in-out hover:-translate-y-2 hover:shadow-lg">
      {/* HEADER SECTION */}
      <div className="flex items-center space-x-5 px-6 py-6 rounded-t-xl border-b border-gray-100">
        <img
      ...
      {/* BODY SECTION */}
      <div className="px-6 py-6 space-y-4 text-sm text-gray-600 dark:text-gray-300">
        ...
        <div className="flex items-center gap-5">
          <IconBrandDribbble className="h-4 w-4 text-gray-500" />
